...
export { default as AnalyticsFacultyTable } from './AnalyticsFacultyTable';
export { default as AnalyticsDepartmentPerformance } from './AnalyticsDepartmentPerformance';
