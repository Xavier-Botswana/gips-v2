...
import SearchNotFound from '../../../../components/SearchNotFound'; import useSettings from '../../../../hooks/useSettings';
...
export default function AnalyticsWebsiteVisits() {
  ...
  useEffect(() => {
    const getUsers = async () => {
      const response = await axios.get('/v1/analytics/by-module');
  ...
  return (
    ...
    // </Card>
    <Card>
      <CardHeader title="Performance by Module" subheader=" " />
      <Box sx={{ p: 2, pb: 0 }}>
        {/* <div
          style={{
            display: 'grid',
          ...
          <Table>
            ...
            <TableBody>
              {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                const { id, moduleName, lowestMark, highestMark, averageMark } = row;
                const isItemSelected = selected.indexOf(moduleName) !== -1;
                ...
                return (
                  ...
                  >
                    <TableCell padding="checkbox">
                      <Checkbox checked={isItemSelected} onClick={() => handleClick(moduleName)} />
                    </TableCell>
