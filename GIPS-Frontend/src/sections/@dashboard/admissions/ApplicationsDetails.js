...
export default function ApplicationsDetails({ isEdit, currentUser, applicantDetails }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      option_one: applicantDetails.expand?.option_one?.course_name || '',
      ...
      semester: applicantDetails.expand?.semester_id.name || '',
  ...
  const onSubmit = async (data) => {
    try {
      ...
      //   axios.patch(`api/v1/applications/${currentUser.id}`, application).then(() => {
    ...
    <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
        ...
        <Grid item xs={12} md={16}>
          <Card sx={{ p: 3 }}>
            ...
            >
              ...
              <RHFTextField name="phoneNumber" label="Telephone" disabled />
            ...
            >
              <RHFTextField name="points" label="Points" disabled />
            ...
            <Box sx={{ marginBottom: 2 }}>
              ...
              >
                ...
                {applicantDetails.points > 30 && applicantDetails.points < 36 ? (
                  <div>
                    <Typography variant="subtitle1" gutterBottom>
                      OVC Letter
                    </Typography>
      ...
      {statusUpate.current === 'Approve' ? (
        <CheckoutNewAddressForm
          ...
          sponsor={applicantDetails.sponsorship}
          onClose={handleClose}
