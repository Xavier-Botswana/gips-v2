...
const TABLE_HEAD = [
  ...
  { id: 'status', label: 'Sponsorship Status', alignRight: false },
...
export default function FirstTimeApplicationList() {
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell align="right">
                                <StudentMoreMenu onDelete={() => handleDeleteUser(id)} userName={name} />
                              </TableCell>
                            </TableRow>
                          );
                        })}
